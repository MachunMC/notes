...
- 存储密度：指存储空间的利用率。顺序存储的空间全部存储有效数据，没有空间浪费；链式存储除了存储有效数据，还需要存储指针
- 容量分配：存储空间的分配
- 读运算：指读第几个元素
...
- 一般二叉树
- 满二叉树：除叶子节点外，其他结点都有两个子节点
- 完全二叉树：除最后一层外，其他各层的结点都有两个子节点，且最后一层的结点**从左到右**连续分布。**满二叉树是一种特殊的完全二叉树**

![](https://note.youdao.com/yws/public/resource/28dd1bb1f4873a4dfd6f74ad8774c65a/xmlnote/96EED0C7B8C24A18816F3EC8876AD209/29624)
